...
from .views import RegisterUserView, MyObtainTokenPairView, SendEmailView, VerifyEmailView, SendEmailPasswordView, VerifyEmailPasswordView, SetNewPasswordView
